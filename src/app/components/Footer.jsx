  ...
  return (
    <div className="flex flex-col bg-[#F2F2F2]">
      ...
      <div className="flex flex-col md:flex-row justify-evenly items-start gap-10 md:gap-0 px-5 md:px-10 py-10">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div className="flex flex-col items-start text-center md:text-left">
            <span className="font-opensans text-lg md:text-[20px] font-semibold">Crimpbyte</span>
            <span className="font-opensans text-base md:text-[16px]">Innovating for a Sustainable Future</span>
          </div>
        </div>

        {/* Quick Links */}
        <div className="flex flex-col items-start">
          <span className="font-opensans text-lg md:text-[20px] font-semibold">Quick Links</span>
        ...
        {/* Contact Info */}
        <div className="flex flex-col items-start">
          <span className="font-opensans text-lg md:text-[20px] font-semibold">Contact Us</span>
          <ul className="list-none flex flex-col gap-2 font-opensans text-base md:text-[16px]">
            <li className="flex items-center gap-2"><FaEnvelope /> crimpbyte@gmail.com</li>
            <li className="flex items-center gap-2"><FaPhone /> +234 9015343134</li>
            <li className="flex items-start gap-2"><FaLocationPin /> Department of Computer Engineering,<br />University of Benin, Edo State, NG</li>
          </ul>
        </div>
      </div>
      ...
      <div className="text-center md:text-right py-5 text-sm px-5">
        &copy; 2024 Crimpbyte. All rights reserved. Privacy Policy | Terms of Service
      </div>
    </div>
  );
}
