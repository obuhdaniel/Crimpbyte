...
function PortfolioPage() {
  return (
    ...
    <div className="flex flex-col items-start w-full p-6 bg-[#f2f2f2]  rounded-lg space-y-4">
      <h1 className=" font-optima text-3xl font-bold text-[24px] text-gray-800">The Crimpbyte Difference</h1>
      <p className="font-opensans text-[15px] max-w-4xl text-gray-700 leading-relaxed">
